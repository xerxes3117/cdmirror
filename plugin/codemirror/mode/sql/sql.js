...
CodeMirror.defineMode("sql", function(config, parserConfig) {
  ...
  var client         = parserConfig.client || {},
      ...
      //keywords       = parserConfig.keywords || {}, /*change*/
  ...
  function tokenBase(stream, state) {
    ...
    if (support.hexNumber &&
      ...
      //if (keywords.hasOwnProperty(word)) return "keyword"; /*change*/
...
(function() {
  ...
  var sqlKeywords = ""; /*change this might not be necessary*/
  ...
  CodeMirror.defineMIME("text/x-sql", {
    name: "sql",
    //keywords: set(sqlKeywords + "begin"), /*change might not be required*/
